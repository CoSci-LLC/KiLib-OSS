...
namespace KiLib
{
   ...
   public:
      ...
      std::optional<KiLib::Vec3> FindClosestStreamCell(size_t ind, const KiLib::Vec3 &inPos, const KiLib::Raster &elev, double radius, double threshold, double runoutAngle) const;
